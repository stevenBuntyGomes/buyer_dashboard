...
import { NewSupplierColumns, newSupplierData } from './SupplierTableList';


const NewSupplierList = () => {
  return (
    <Fragment>
      <Breadcrumbs parent={`${API_ENDPOINT}/app/ecommerce/new-supplier/Dubai`} title="List Of New Suppliers" mainTitle="List Of New Suppliers" />
                        ...
                        <Card>
                            ...
                            <CardBody>
                                <div className='table-responsive product-table'>
                                    <DataTable noHeader pagination paginationServer columns={NewSupplierColumns} data={newSupplierData} highlightOnHover={true} striped={true} responsive={true} />
                                </div>
                                {/* <ProductTableData /> */}
                            </CardBody>
                        </Card>
